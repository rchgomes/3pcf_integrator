...
def generate_ini_files(template_content):
    #ddE_variants = ["dEd", "Edd", "dEE", "EdE", "EEd", "EEE"]
    ddE_variants = ["ddE"]
    range_variants = ["2000to3000", "3000to4000", "4000to5000"]
    ...
    for ddE_var, range_var in itertools.product(ddE_variants, range_variants):
        ...
        new_content = new_content.replace("1000to2000", range_var)
...
with open("generate_training_set_ddE_1000to2000.ini", "r") as f:
